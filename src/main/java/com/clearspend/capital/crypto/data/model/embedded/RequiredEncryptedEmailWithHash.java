...
@Embeddable
@NoArgsConstructor
public class RequiredEncryptedEmailWithHash implements WithEncryptedString {
  ...
  public RequiredEncryptedEmailWithHash(@NonNull String string) {
    this.encrypted = Canonicalizer.EMAIL.forEncryption(string);
    this.hash = HashUtil.calculateHash(Canonicalizer.EMAIL.forHash(string));
  }
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof RequiredEncryptedEmailWithHash that)) {
      return false;
    }
