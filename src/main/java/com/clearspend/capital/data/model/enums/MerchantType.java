...
public enum MerchantType {
  ...
  AGRICULTURAL_COOPERATIVE("agricultural_cooperative", "Agricultural Cooperative", 763),
  ...
  COMMERCIAL_PHOTOGRAPHY_ART_AND_GRAPHICS(
      "commercial_photography_art_and_graphics", "Commercial Photography, Art and Graphics", 7333),
  ...
  CONSULTING_PUBLIC_RELATIONS("consulting_public_relations", "Consulting, Public Relations", 7392),
  ...
  DIRECT_MARKETING_OUTBOUND_TELEMARKETING(
      "direct_marketing_outbound_telemarketing", "Direct Marketing - Outbound Telemarketing", 5966),
  ...
  FUEL_DEALERS_NON_AUTOMOTIVE("fuel_dealers_non_automotive", "Fuel Dealers (Non Automotive)", 5983),
  ...
  GROCERY_STORES_SUPERMARKETS("grocery_stores_supermarkets", "Grocery Stores, Supermarkets", 5411),
  ...
  JEWELRY_STORES_WATCHES_CLOCKS_AND_SILVERWARE_STORES(
      ...
      5944),
  LANDSCAPING_SERVICES("landscaping_services", "Landscaping Services", 780),
  ...
  MENS_AND_BOYS_CLOTHING_AND_ACCESSORIES_STORES(
      ...
      5611),
  MENS_WOMENS_CLOTHING_STORES("mens_womens_clothing_stores", "Mens, Womens Clothing Stores", 5691),
  ...
  NURSERIES_LAWN_AND_GARDEN_SUPPLY_STORES(
      "nurseries_lawn_and_garden_supply_stores", "Nurseries, Lawn and Garden Supply Stores", 5261),
  ...
  PIECE_GOODS_NOTIONS_AND_OTHER_DRY_GOODS(
      "piece_goods_notions_and_other_dry_goods", "Piece Goods, Notions, and Other Dry Goods", 5131),
  PLUMBING_HEATING_EQUIPMENT_AND_SUPPLIES(
      "plumbing_heating_equipment_and_supplies", "Plumbing, Heating Equipment, and Supplies", 5074),
  ...
  REAL_ESTATE_AGENTS_AND_MANAGERS_RENTALS(
      "real_estate_agents_and_managers_rentals", "Real Estate Agents and Managers - Rentals", 6513),
  ...
  VETERINARY_SERVICES("veterinary_services", "Veterinary Services", 742),
  ...
  private static Map<Integer, MerchantType> initializeMccMap() {
    return Arrays.stream(MerchantType.values())
        .collect(Collectors.toUnmodifiableMap(e -> e.mcc, Function.identity()));
  }

  MerchantType(String stripeMerchantType, String description, int mcc) {
