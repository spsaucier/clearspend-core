...
// Copied from https://gist.github.com/webdevwilson/5271984#file-state-java
public enum State {
  ALABAMA("Alabama", "AL"),
  ALASKA("Alaska", "AK"),
  ...
  public static State valueOfRegion(final String region) {
    State result = valueOfName(region);
    if (result == State.UNKNOWN) {
      result = valueOfAbbreviation(region);
    }
