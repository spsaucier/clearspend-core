                 ...
                 COALESCE((
                              SELECT CASE
                                         WHEN business.status = 'CLOSED'
                                             THEN array(SELECT unnest(permissions)
                                                        intersect
                                                        SELECT unnest(array ['READ', 'VIEW_OWN']::allocationpermission[]))
         ...
         FROM (
                  ...
                  FROM (
                           SELECT -- this clause fetches explicit AllocationPermissions
                                  ...
                                  allocation.ancestor_allocation_ids AS ancestor_allocation_ids,
                           ...
                           FROM user_allocation_role
                                    ...
                                    INNER JOIN business_status_filter
                                               ON user_allocation_role.role =
                                                  business_status_filter.role_name
